...
export class AlbumsComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.titleMetaService.setMeta(
      'Espacio Dios: Music: Albums',
      'Check out all Espacio Dios albums',
      'https://espaciodios.com/assets/espacio-backround-min.jpg',
      'https://espaciodios.com/music/category/albums',
      'summary',
      'Espacio Dios, Espacio, Espacio dios website, Espacio dios albums, Espacio dios music');
  }
